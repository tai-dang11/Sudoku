...
def checkZero(crop_puzzel, crop_ori, x, y):
    ...
    zero = cv2.imread('/Users/dttai11/Sudoku/backend/api/extract_model/preprocess_image/test_image/zero_template.jpg', cv2.IMREAD_GRAYSCALE)
...
def create_np_puzzel(imgl):
    ...
    np.save("/Users/dttai11/Sudoku/backend/api/extract_model/preprocess_image/nparray/ans", sudoku_numbers)
