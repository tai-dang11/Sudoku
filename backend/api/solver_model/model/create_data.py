...
answer_path = '/Users/dttai11/Sudoku/backend/api/solver_model/dataset/processed_data/ans.npy'
puzzel_path = '/Users/dttai11/Sudoku/backend/api/solver_model/dataset/processed_data/puzzle.npy'
...
def processed_data(batch_size):
    ...
    puzzle = np.load('/Users/dttai11/Sudoku/backend/api/solver_model/dataset/processed_data/puzzle.npy')
    answer = np.load('/Users/dttai11/Sudoku/backend/api/solver_model/dataset/processed_data/ans.npy')
